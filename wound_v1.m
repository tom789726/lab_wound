...
% if (isfield(handles,'scale'))
%    scale = handles.scale;
%    lineROI = handles.line;
%    distX = lineROI.Position(2,1) - lineROI.Position(1,1);
%    distY = lineROI.Position(1,2) - lineROI.Position(1,2);
%    sizePerPixel = 0;
%    count = count*sizePerPixel;
%    message = sprintf("Approximated Area: %0.2f mm",count); 
% end
